...
namespace HMI.Handmenu
{
    ...
    /// </summary>
    [ExportView("H_M4_Mani_Rotary")]
 
    public partial class H_M4_Mani_Rotary : View
    {
        public H_M4_Mani_Rotary()
        {
        ...
        private void Picker_Loaded(object sender, System.Windows.RoutedEventArgs e)
        {
            short V = (short)ApplicationService.GetVariableValue("NLM4.PLC.Blocks.4 Modul 4.07 Manipulator.01 Mani Fahr.DB Mani04 Fahr HMI.Actual value.Position Textliste");
            if (V == 8) 
            {
                ApplicationService.SetVariableValue("NLM4.PLC.Blocks.4 Modul 4.07 Manipulator.03 Mani Drehen.DB Mani04 Drehen HMI.Set Value.Vorwahl Position Textliste",7);
            }
        }
    }
}