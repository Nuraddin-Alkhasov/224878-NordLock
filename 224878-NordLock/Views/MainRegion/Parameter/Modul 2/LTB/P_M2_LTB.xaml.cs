...
namespace HMI.Parameter
{
    ...
    /// </summary>
    [ExportView("P_M2_LTB")]
    public partial class P_M2_LTB : View
    {
        ...
        {
            Reg.Content = new P_M2_LTB_P();
        }

        private void B_Checked(object sender, System.Windows.RoutedEventArgs e)
        {
            Reg.Content = new P_M2_LTB_B();
        }
        private void Paint_Checked(object sender, System.Windows.RoutedEventArgs e)
        {
            Reg.Content = new P_M2_LTB_Paint();
        }
