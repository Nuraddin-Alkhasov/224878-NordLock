...
namespace HMI.Parameter
{
    ...
    /// </summary>
    [ExportView("P_M3_Mani_Lift")]
    public partial class P_M3_Mani_Lift : View
    {
		
        public P_M3_Mani_Lift()
        {
