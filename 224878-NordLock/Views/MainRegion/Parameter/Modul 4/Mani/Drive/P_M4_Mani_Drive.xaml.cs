...
namespace HMI.Parameter
{
    ...
    /// </summary>
    [ExportView("P_M4_Mani_Drive")]
    public partial class P_M4_Mani_Drive : View
    {
		
        public P_M4_Mani_Drive()
        {
        ...
        private void P_Checked(object sender, System.Windows.RoutedEventArgs e)
        {
             Task obTask = Task.Run(() =>
            {
                ...
                {
                    Reg.Content = new P_M4_Mani_Drive_P();
                });
            });
        ...
        private void B_Checked(object sender, System.Windows.RoutedEventArgs e)
        {
            Task obTask = Task.Run(() =>
            {
                Application.Current.Dispatcher.InvokeAsync((Action)delegate
                {
                    Reg.Content = new P_M4_Mani_Drive_B();
                });
            });
