...
namespace HMI.Views.MainRegion.Recipe
{
	...
	/// </summary>
	[ExportView("Recipe_Article_TAR")]
	public partial class Recipe_Article_TAR : VisiWin.Controls.View
	{

        public Recipe_Article_TAR()
		{
			this.InitializeComponent();
			IRecipeClass T = ApplicationService.GetService<IRecipeService>().GetRecipeClass("Article");
			T.SetValue("NL.PLC.Blocks.50 HMI.01 PC.DB PC.LD.Station.Tablett auskippen Rückführung.Kippinterval[1].Angle", 180);
		}
