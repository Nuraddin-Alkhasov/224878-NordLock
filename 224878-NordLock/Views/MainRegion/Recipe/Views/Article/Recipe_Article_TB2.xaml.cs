...
namespace HMI.Views.MainRegion.Recipe
{
	...
	/// </summary>
	[ExportView("Recipe_Article_TB2")]
	public partial class Recipe_Article_TB2 : VisiWin.Controls.View
	{

        public Recipe_Article_TB2()
		{
			this.InitializeComponent();
            IRecipeClass T = ApplicationService.GetService<IRecipeService>().GetRecipeClass("Article");
            T.SetValue("NL.PLC.Blocks.50 HMI.01 PC.DB PC.LD.Station.Trockner Band 2.Abdunstzeiten.Minute", 2);
        }
